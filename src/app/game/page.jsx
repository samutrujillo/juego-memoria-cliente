...
export default function Game() {
  ...
  // Añadir estado para controlar la lluvia de monedas
  ...
  const showPointsAlert = (points) => {
    ...
    // Mostrar lluvia de monedas solo si ganó puntos
    if (isPositive) {
  ...
  return (
    <>
      ...
      <div className="game-container game-page">
        ...
        <CoinRain active={showCoinRain} onComplete={handleCoinRainComplete} />
      </div>
    </>
  );
}
